...
class TestMasks(unittest.TestCase):
    ...
    def test_card_number_invalid_cases(self):
        ...
        self.assertEqual(get_mask_card_number("123456789012345678901234567890"),
                         "1234 56** **** 7890")  # Слишком длинный номер
        self.assertEqual(get_mask_card_number("4000-1111-2222-3333"),
                         "4000 -1** **** 3333")  # С дефисами
    ...
    def test_account_number_invalid_cases(self):
        ...
        self.assertEqual(get_mask_account("123456789012345678901234567890"),
                         "**7890")  # Слишком длинный номер
        self.assertEqual(get_mask_account("4000-1111-2222-3333"),
                         "**3333")  # С дефисами
